...
public class MyBinaryRecursiveSearch {
    /**
     * sortedArray -> array must be sorted as input
     * start -> which element do you want to search
     * end -> which element do you want to end
